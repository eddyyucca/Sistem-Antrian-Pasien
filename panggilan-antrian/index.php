  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2024 - <a href="https://www.github.com/eddyyucca/" target="_blank" class="text-danger text-decoration-none">IT BUMA Developer</a>. All rights reserved.
      </div>
    </div>
  </footer>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] + ", menuju, meja, untuk, diperiksa", "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
